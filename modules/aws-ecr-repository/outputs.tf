...
output "lifecycle_policy_id" {
  description = "The repository name that the lifecycle policy is associated with."
  value       = length(aws_ecr_lifecycle_policy.this) > 0 ? aws_ecr_lifecycle_policy.this[0].id : null
}

output "repository_policy_id" {
  description = "The repository name that the repository policy is associated with."
