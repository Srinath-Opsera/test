...
| `force_overwrite_replica_secret` | Overwrite existing replica secrets during replication | `bool` | `false` | no |
...
- The Lambda function must have permission to be invoked by Secrets Manager.
