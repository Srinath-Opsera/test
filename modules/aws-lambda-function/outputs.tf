...
output "alias_name" {
  description = "The name of the Lambda alias (if created)."
...
output "function_url" {
  description = "The HTTPS URL endpoint for the Lambda function URL (if created)."
  value       = var.create_function_url ? aws_lambda_function_url.this[0].function_url : null
}

output "function_url_id" {
  description = "The unique ID of the Lambda function URL (if created)."
