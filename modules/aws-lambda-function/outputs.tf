...
output "function_qualified_arn" {
  description = "The qualified ARN (including version) of the Lambda function."
...
output "security_group_id" {
  description = "The ID of the security group created for the Lambda function (VPC only)."
...
output "alias_invoke_arn" {
  description = "The ARN used to invoke the Lambda alias from API Gateway."
...
output "function_url_id" {
  description = "The unique ID of the Lambda function URL."
